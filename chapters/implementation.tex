...
\item\item[\texttt{\textcolor{blue}{ElementPtr} * to, from;}]
\item[\texttt{\textcolor{blue}{Point\_2} entryPoint, exitPoint}] Those two items keep track of the tour through the drawing. From and to are pointers to the previous and next element, exit- and entrypoint are the points on the element where the tour is entering and leaving.
