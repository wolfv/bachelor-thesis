...
\caption{Possible entry- and exit vertices and direction of traversal for polylines and polygons. Note that the polygon could also be traversed in counterclockwise direction.}\label{fig:connect}
\end{figure}
